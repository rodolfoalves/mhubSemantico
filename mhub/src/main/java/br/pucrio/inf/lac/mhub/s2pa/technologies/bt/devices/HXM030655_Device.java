...
import br.pucrio.inf.lac.mhub.s2pa.technologies.bt.interfaces.BTTechnologySensor;
import br.pucrio.inf.lac.mhub.s2pa.technologies.bt.sensors.HXM030655_AbstractSensor;
import br.pucrio.inf.lac.mhub.s2pa.technologies.bt.sensors.HXM030655_CadenceSensor;
import br.pucrio.inf.lac.mhub.s2pa.technologies.bt.sensors.HXM030655_DistanceSensor;
import br.pucrio.inf.lac.mhub.s2pa.technologies.bt.sensors.HXM030655_HeartBeatNumSensor;
import br.pucrio.inf.lac.mhub.s2pa.technologies.bt.sensors.HXM030655_HeartRateSensor;
import br.pucrio.inf.lac.mhub.s2pa.technologies.bt.sensors.HXM030655_InstantSpeedSensor;
import br.pucrio.inf.lac.mhub.s2pa.technologies.bt.sensors.HXM030655_StridesSensor;
 ...
 * @author bertodetacio
 */
public class HXM030655_Device extends BTMobileObject {


    //faz o mapeamento de um sensor para cada serviço
    private Hashtable<String, HXM030655_AbstractSensor> sensors = new Hashtable<>();
    ...
    private void inicializeSensors() {
        ...
        addSensor(HXM030655_CadenceSensor.getInstance());
        addSensor(HXM030655_HeartBeatNumSensor.getInstance());
        addSensor(HXM030655_StridesSensor.getInstance());
    }



    @Override
    public List<BTTechnologySensor> getServices() {
        ArrayList<BTTechnologySensor> services = new ArrayList<>();
