...
import br.pucrio.inf.lac.mhub.s2pa.technologies.bt.interfaces.BTTechnologyDevice;

/**
 * @author bertodetacio
 */
@SuppressLint("NewApi")
public abstract class BTMobileObject implements TechnologyDevice, BTTechnologyDevice {
        ...
        try {
            ...
            if (arrayData != null) {
               ...
               for(SensorData sensorData: sensorDataList){
                   ...
                   btTechnologyListener.onMObjectValueRead(getMouuid(),getRssi(),sensorData.getSensorName(),sensorData.getSensorValue(), sensorData.getProperties());
               }
            }
        } catch (Exception e) {
